...
if [ "${GPUCALL_PUBLIC_RELEASE_REMOTE:-0}" = "1" ]; then
  ...
  curl -fsSL https://raw.githubusercontent.com/noiehoie/gpucall/v2.0.8/docs/EXTERNAL_SYSTEM_ONBOARDING_PROMPT.md | sed -n '1,6p'
  curl -fsSL https://raw.githubusercontent.com/noiehoie/gpucall/v2.0.8/docs/EXTERNAL_SYSTEM_ONBOARDING_MANUAL.md | sed -n '1,6p'
