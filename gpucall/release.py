...
GITHUB_RELEASE_BASE = f"https://github.com/noiehoie/gpucall3/releases/download/{GITHUB_RELEASE_TAG}"
GITHUB_RAW_TAG_BASE = f"https://raw.githubusercontent.com/noiehoie/gpucall3/{GITHUB_RELEASE_TAG}"
