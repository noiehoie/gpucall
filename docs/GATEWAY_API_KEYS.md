...
GPUCALL_SDK_WHEEL_URL='https://github.com/noiehoie/gpucall/releases/download/v2.0.20/gpucall_sdk-2.0.20-py3-none-any.whl'
```
...
CALLER_HELPER_INSTALL=https://github.com/noiehoie/gpucall/releases/download/v2.0.20/gpucall_sdk-2.0.20-py3-none-any.whl
```
