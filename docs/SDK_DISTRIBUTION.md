...
```bash
uv add "gpucall-sdk @ file:///opt/gpucall/artifacts/sdk/python/gpucall_sdk-2.0.22-py3-none-any.whl"
```

For another host, copy the wheel first:

```bash
scp gateway.example.internal:/opt/gpucall/artifacts/sdk/python/gpucall_sdk-2.0.22-py3-none-any.whl ./vendor/
uv add "gpucall-sdk @ file://${PWD}/vendor/gpucall_sdk-2.0.22-py3-none-any.whl"
```
