...
uv tool run --from https://github.com/noiehoie/gpucall/releases/download/v2.0.33/gpucall_sdk-2.0.33-py3-none-any.whl gpucall-recipe-draft --help
curl -fsSLO https://github.com/noiehoie/gpucall/releases/download/v2.0.33/SHA256SUMS
```
