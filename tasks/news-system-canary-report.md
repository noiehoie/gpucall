...
| Translate stage `503 PROVIDER_CAPACITY_UNAVAILABLE` ×20 during the 14:00 pipeline run | provider temporary: parallel translate calls saturated Modal T4 concurrency | provider/temporary | bounded, retryable classification; no product change in this session (recorded for capacity planning) |
