...
def test_trusted_bootstrap_issues_tenant_key_without_existing_auth(tmp_path, monkeypatch) -> None:
    ...
    (root / "admin.yml").write_text(
        "\n".join(
            [
                ...
                "caller_sdk_wheel_url: http://assets.gpucall.internal/gpucall_sdk-2.0.25-py3-none-any.whl",
            ]
        )
        + "\n",
        encoding="utf-8",
    ...
    assert issued["handoff"]["GPUCALL_SDK_WHEEL_URL"] == "http://assets.gpucall.internal/gpucall_sdk-2.0.25-py3-none-any.whl"
